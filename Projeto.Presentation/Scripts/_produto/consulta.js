    ...
    $.ajax({
        ...
        success: function (lista) {
            ...
            $.each(lista, function (i, item) {
                ...
                conteudo += "<td>";
                conteudo += "<button onclick='obterProduto(" + item.IdProduto + ")' class='btn btn-primary btn-sm' data-target='#janelaedicao' data-toggle='modal'>Atualizar</button>";
                conteudo += "&nbsp;"; //espaço
                conteudo += "<button onclick='obterProduto(" + item.IdProduto + ")' class='btn btn-danger btn-sm' data-target='#janelaexclusao' data-toggle='modal'>Excluir</button>";
                conteudo += "</td>";
                conteudo += "</tr>";
            });
